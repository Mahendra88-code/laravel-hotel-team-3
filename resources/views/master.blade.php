...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('dist/css/tooltipster.bundle.min.css')}}" />

  <script type="text/javascript" src="http://code.jquery.com/jquery-1.10.0.min.js"></script>
  <script type="text/javascript" src="{{ asset('dist/js/tooltipster.bundle.min.js')}}"></script>
</head>
...
<body class="sidebar-mini" contextmenu="return false;">  
  <div class="wrapper">
